		...
		var pearAdmin = new function () {
			...
			this.switchTheme = function (checked) {
				...
				if (checked === true || checked === "true") {
					...
					document.getElementById('layui-theme-dark-css').setAttribute('href','/app/admin/admin/css/layui-theme-dark.css')
					document.getElementById('xm-select-dark-css').setAttribute('href','/app/admin/admin/css/xm-select-dark.css')
				}else{
